...
##Note:
# Using qgraph you can save directly as a png, no need for pdfs.
# From what I understood you can set gamma in the qgraph function directly (eg. line 95)
  # using either gamma or tuning (see line 93)
#There is the option to do a clustering plot in a one liner (see line 101-102)
...
setwd("C:/Users/35387/Dropbox/Documents/Brownlees/final project/psychometric_networks/psychometric_networks")
data_full<-read.spss("PTSD_data_V1.sav", to.data.frame=TRUE)

#changing the wd to location for saved plots
setwd("C:/Users/35387/Dropbox/Documents/Brownlees/final project/psychometric_networks/psychometric_networks/plots")
...
data$'26' <- as.numeric(data$'26') #without this fig3 will not work
...
graph_ptsd.m <-EBICglasso(data_ptsd.cor, n = nrow(data_ptsd), gamma = 0.5) 
...
graph_ptsd.g<-qgraph(data_ptsd.cor, labels=names, graph="glasso", layout="spring", 
                     ...
                     tuning = 1,
                     title = 'Gamma = 1', title.cex = 0.5, 
                     filename = 'gamma_one', filetype = 'png')


### B. Figure 2 
pdf("Centrality_ptsd.pdf")
centralityPlot(graph_ptsd.g, include = c('Strength', 'Closeness', 'Betweenness'))

#CLUSTERING PLOT
#clusteringPlot(graph_ptsd.g)
dev.off()
...
dev.off()
pdf("Centrality_all.pdf")
centralityPlot(graph.g, include = c('Strength', 'Closeness', 'Betweenness'))
#clusteringPlot(graph_ptsd.g)
dev.off()
